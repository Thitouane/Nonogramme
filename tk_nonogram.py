...
class CGridText(CGrid):
    ...
    def settext(self, x, y, text):
        ...
        textitem=None
        if text is not None:
            textitem=self.canvas.create_text(xcenter, ycenter, text=text)
...
Elle est appelée par le bouton Quit de l'application. 
    ...
    def setcols(self, x, y, value):
        self.cols.settext(x, y, value)

    def setrows(self, x, y, value):
        self.rows.settext(x, y, value)
